# backend/adapters/tradeindia.py
# ProspectLens — TradeIndia Extraction Adapter

from adapters.base import BaseAdapter

class TradeIndiaAdapter(BaseAdapter):
    def validate_page(self, url: str) -> bool:
        return "tradeindia.com" in url.lower()
    ...
    def get_site_information(self) -> dict:
        return {
            "source_key": "tradeindia",
            "display_name": "TradeIndia",
            "adapter_class": "TradeIndiaAdapter"
        }
    ...
    def is_search_results_page(self, url: str) -> bool:
        url = url.lower()
        return "tradeindia.com/seller" in url or "search.html" in url or "tradeindia.com/fp" in url

    def is_detail_page(self, url: str) -> bool:
        url = url.lower()
        return "/company/" in url or "tradeindia.com/co/" in url
    ...
    def get_page_type(self, url: str) -> str:
        ...
        if "/login" in url or "signin" in url:
            return "Login"
        if url.endswith("tradeindia.com") or url.endswith("tradeindia.com/"):
            return "Home"
        return "Unknown"
